        ...
        <div className="mb-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-5 flex flex-col md:flex-row md:items-center justify-between gap-3">
            ...
            <div className="flex space-x-2">
              <a href={`/admin/user_edit?id=${user.id}`} className="px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600"><i className="fas fa-edit mr-2" />Edit</a>
              <a href="/admin/users" className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300"><i className="fas fa-arrow-left mr-2" />Kembali</a>
            </div>
          </div>
        </div>
              ...
              <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
                ...
                <div className="divide-y divide-gray-100">
                  {services.map((service) => (
                    <a key={service.id} href={`/admin/service_detail?id=${service.id}`} className="flex items-center p-5 hover:bg-gray-50">

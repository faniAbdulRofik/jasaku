            ...
            <div className="p-4 md:p-5">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-5">
                ...
                <div className="flex space-x-2">
                  <a href={`/admin/booking_edit.php?id=${booking.id}`} className="px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition-colors flex items-center">
                    <i className="fas fa-edit mr-2" /> Edit
                  </a>
                  <a href="/admin/bookings.php" className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors flex items-center">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="p-5 text-center">
                ...
                <a href={`/admin/user_detail.php?id=${booking.customer_id}`} className="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100" data-aos="fade-up" data-aos-delay="250">
              ...
              <div className="p-5 text-center">
                ...
                <a href={`/admin/user_detail.php?id=${booking.provider_id}`} className="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                  <i className="fas fa-user-circle mr-2" /> Lihat Profile
                </a>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100" data-aos="fade-up" data-aos-delay="300">
              ...
              <div className="p-5 space-y-3">
                <a href={`/admin/booking_edit.php?id=${booking.id}`} className="w-full flex items-center justify-center px-4 py-2 rounded-md shadow-sm text-sm font-medium text-white bg-yellow-500 hover:bg-yellow-600">

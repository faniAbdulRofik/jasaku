...
export default async function AdminDashboard({ searchParams }: PageProps) {
  ...
  if (!user || user.role !== "admin") redirect("/login.php?error=Anda tidak memiliki akses admin");
  ...
  return (
    <>
      ...
      <DashboardShell role="admin" active="/admin/dashboard.php" title="Admin Dashboard">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
              ...
              <div className="p-5">
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ["/admin/users.php", "Add User", "fa-user-plus", "from-blue-500 to-blue-600", "hover:border-blue-500 hover:bg-blue-50", "group-hover:text-blue-600"],
                    ["/admin/services.php", "Add Service", "fa-plus-circle", "from-green-500 to-green-600", "hover:border-green-500 hover:bg-green-50", "group-hover:text-green-600"],
                    ["/admin/bookings.php", "Manage Bookings", "fa-calendar-plus", "from-purple-500 to-purple-600", "hover:border-purple-500 hover:bg-purple-50", "group-hover:text-purple-600"],
                    ["/admin/settings.php", "Settings", "fa-cog", "from-yellow-500 to-yellow-600", "hover:border-yellow-500 hover:bg-yellow-50", "group-hover:text-yellow-600"],

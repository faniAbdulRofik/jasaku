          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100">
            <div className="p-4 md:p-5">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-5">
                ...
                <a href={`/admin/booking_detail?id=${booking.id}`} className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors flex items-center">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
              ...
              <form action={updateBookingStatusAction} className="p-5 space-y-5">
                ...
                <div className="flex justify-end space-x-3 pt-4 border-t border-gray-100">
                  <a href={`/admin/booking_detail?id=${booking.id}`} className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">Batal</a>

...
export default async function AdminServiceDetail({ searchParams }: PageProps) {
  ...
  if (!detail) redirect("/admin/services.php?error=Layanan tidak ditemukan");
        ...
        <div className="mb-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-5 flex flex-col md:flex-row md:items-center justify-between gap-3">
            ...
            <div className="flex space-x-2">
              <a href={`/admin/service_edit.php?id=${service.id}`} className="px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700"><i className="fas fa-edit mr-2" />Edit</a>
              <a href="/admin/services.php" className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg bg-white hover:bg-gray-50"><i className="fas fa-arrow-left mr-2" />Kembali</a>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
              ...
              <BookingTable bookings={serviceBookings} role="admin" returnTo="/admin/bookings.php" compact />
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
              ...
              <div className="p-5 text-center">
                ...
                <a href={`/admin/user_detail.php?id=${service.provider_id}`} className="mt-3 inline-flex items-center px-3 py-1.5 border border-gray-300 rounded-md text-gray-700 bg-white hover:bg-gray-50">

...
export default async function AdminCategoryEdit({ searchParams }: PageProps) {
  ...
  if (!category) redirect("/admin/categories?error=Kategori tidak ditemukan");
      ...
      <DashboardShell role="admin" active="/admin/categories" title="Admin Dashboard">
        <div className="mb-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-5 flex items-center justify-between">
            ...
            <a href="/admin/categories" className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300"><i className="fas fa-arrow-left mr-2" />Kembali</a>
          </div>
        </div>
              ...
              <div className="p-5">
                <form action={adminSaveCategoryAction}>
                  ...
                  <div className="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="/admin/categories" className="btn btn-secondary me-md-2">Batal</a>

        ...
        <div className="min-h-screen bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="bg-white rounded-lg shadow-sm p-12 text-center">
              ...
              <a href="/search.php" className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Kembali ke pencarian</a>
            </div>
          </div>
        </div>
      </PageChrome>
                    ...
                    {otherServices.length > 0 ? (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {otherServices.map((item) => (
                          <a key={item.id} href={`/service_detail.php?id=${item.id}`} className="flex items-center p-3 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors">
                        ...
                        {providerServices.map((item) => (
                          <div key={item.id} className="border-b border-gray-100 pb-4 last:border-b-0">
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <a href={`/service_detail.php?id=${item.id}`} className="text-blue-600 hover:text-blue-800 font-medium">{item.title}</a>
                                <div className="flex items-center mt-1">
                                  <div className="flex items-center space-x-1">
                                    {[1, 2, 3, 4, 5].map((star) => (
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                {user?.role === "customer" ? (
                  ...
                  <>
                    ...
                    <div className="space-y-3">
                      <a href="/login.php" className="block w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 transition-colors font-semibold text-center">
                        <i className="fas fa-sign-in-alt mr-2" />Login
                      </a>
                      <a href="/register.php" className="block w-full border border-gray-300 text-gray-700 py-3 rounded-lg hover:bg-gray-50 transition-colors font-medium text-center">

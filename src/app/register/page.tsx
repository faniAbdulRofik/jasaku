            ...
            <div className="md:flex">
              <div className="md:w-2/3 p-8">
                ...
                <div className="flex mb-6 rounded-lg bg-gray-100 p-1">
                  <a href="/register?role=customer" className={`flex-1 py-2 px-4 text-center rounded-md ${role === "customer" ? "bg-white shadow-sm text-blue-600 font-medium" : "text-gray-600 hover:text-gray-800"}`}>
                    <i className="fas fa-user mr-2" />Customer
                  </a>
                  <a href="/register?role=provider" className={`flex-1 py-2 px-4 text-center rounded-md ${role === "provider" ? "bg-white shadow-sm text-blue-600 font-medium" : "text-gray-600 hover:text-gray-800"}`}>
                  ...
                  <div className="bg-green-50 border-l-4 border-green-500 p-4 mb-6 rounded">
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="mt-2">
                          <a href="/login" className="inline-flex items-center px-3 py-1 bg-green-600 text-white text-sm rounded-md hover:bg-green-700">
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-gray-600">
                    Sudah punya akun? <a href="/login" className="font-medium text-blue-600 hover:text-blue-500">Login di sini</a>
                  </p>
                </div>
              </div>

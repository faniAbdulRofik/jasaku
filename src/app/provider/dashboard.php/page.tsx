...
export default async function ProviderDashboard({ searchParams }: PageProps) {
  ...
  return (
    <>
      ...
      <DashboardShell role="provider" active="/provider/dashboard.php" title="Provider Dashboard">
            ...
            <div className="p-4 md:p-5">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-5">
                ...
                <div className="flex-shrink-0">
                  <a href="/provider/add_service.php" className="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
            ...
            <div className="p-3 bg-white">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {[
                  ["/provider/add_service.php", "Tambah Layanan", "fa-plus", "from-blue-500 to-blue-600"],
                  ["/provider/bookings.php", "Kelola Booking", "fa-calendar", "from-green-500 to-green-600"],
                  ["/provider/services.php", "Layanan Saya", "fa-concierge-bell", "from-purple-500 to-purple-600"],
                  ["/provider/earnings.php", "Penghasilan", "fa-money-bill-wave", "from-yellow-500 to-yellow-600"],
          ...
          <div className="lg:col-span-2" data-aos="fade-up" data-aos-delay="200">
            <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
              <div className="p-5 border-b border-gray-100 flex justify-between items-center">
                ...
                <a href="/provider/bookings.php" className="text-sm text-blue-600 hover:text-blue-800 font-medium flex items-center">Lihat Semua <i className="fas fa-chevron-right ml-1 text-xs" /></a>
              </div>
              <BookingTable bookings={recentBookings} role="provider" returnTo="/provider/dashboard.php" compact />
            </div>
          </div>
          ...
          <div data-aos="fade-up" data-aos-delay="250">
            <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
              <div className="p-5 border-b border-gray-100 flex justify-between items-center">
                ...
                <a href="/provider/services.php" className="text-sm text-blue-600 hover:text-blue-800 font-medium flex items-center">Lihat Semua <i className="fas fa-chevron-right ml-1 text-xs" /></a>
              </div>
              <div className="p-4 space-y-4">
                {services.length ? services.map((service) => (
                  ...
                  <div className="p-8 text-center bg-white">
                    ...
                    <a href="/provider/add_service.php" className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Tambah Layanan</a>
                  </div>
                )}
              </div>
            </div>

          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <form action={loginAction} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="/forgot_password.php" className="text-sm text-blue-600 hover:text-blue-700">
                  Lupa password?
                </a>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600">
                Belum punya akun?{" "}
                <a href="/register.php" className="text-blue-600 hover:text-blue-700 font-semibold">
                  Daftar sekarang
                </a>
              </p>
            </div>

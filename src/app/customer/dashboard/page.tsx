...
export default async function CustomerDashboard({ searchParams }: PageProps) {
  ...
  return (
    <>
      ...
      <DashboardShell role="customer" active="/customer/dashboard" title="Customer Dashboard">
            ...
            <div className="p-4 md:p-5">
              <div className="flex flex-col space-y-3 md:flex-row md:items-center md:justify-between md:space-y-0">
                ...
                <div className="flex-shrink-0">
                  <a href="/search" className="inline-flex items-center px-4 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 hover:to-blue-700 text-white text-sm font-semibold rounded-lg transition-all duration-150 shadow hover:shadow-md active:scale-[0.98]">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
            ...
            <div className="p-3 bg-white">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {[
                  ["/search", "Find Services", "fa-search", "from-blue-500 to-blue-600"],
                  ["/customer/bookings", "My Bookings", "fa-calendar", "from-green-500 to-green-600"],
                  ["/customer/reviews", "My Reviews", "fa-star", "from-yellow-500 to-yellow-600"],
                  ["/customer/settings", "Settings", "fa-cog", "from-purple-500 to-purple-600"],
        ...
        <div data-aos="fade-up" data-aos-delay="200">
          <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
            <div className="p-5 border-b border-gray-100 flex justify-between items-center">
              ...
              <a href="/customer/bookings" className="text-sm text-blue-600 hover:text-blue-800 font-medium flex items-center">
                View All <i className="fas fa-chevron-right ml-1 text-xs" />
              </a>
            </div>
            <BookingTable bookings={recentBookings} role="customer" returnTo="/customer/dashboard" compact />
          </div>
        </div>
      </DashboardShell>
      <SiteFooter />
